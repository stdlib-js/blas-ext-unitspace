...
```javascript
import unitspace from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-unitspace@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-unitspace@esm/index.mjs';
```
